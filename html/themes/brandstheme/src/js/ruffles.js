...
(function ($, window) {
  ...
  $(document).ready(function () {
    ...
    $(".main-coupon-left, .main-coupon-right").css("visibility", "hidden");

    var couponProductBg=jQuery('.main-coupon-left').attr("data-coupon-bgcolor");
    ...
    $(window).on('scroll', function () {
      ...
      $(".main-coupon-right").each(function () {
        if (isMvScrolledIntoView($(this))) {
          ...
          setTimeout(function () {
            $(".coupon-row").css('background-color',
              '' + couponProductBg + '');
          }, 1000);
        }
      });
  ...
  $("#ruffles-buy").click(function(){
    $(".ruffles-navbar__vertical-align").toggleClass("index");
  });
