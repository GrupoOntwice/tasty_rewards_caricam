...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, Request $request = NULL) {
    ...
    $form['single_mode'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Single push'),
      '#description' => $this->t('If checked, each dataLayer key will generate a different push.'),
      '#default_value' => $datalayer_config->get('single_mode'),
    ];
    $form['debug'] = [
      '#type' => 'checkbox',
    ...
    $form['note'] = [
      '#markup' => $this->t('You can disable GTM Datalayer adding <code>@code</code> to the URL of any page.', [
        '@code' => '?gtm_datalayer=0',
      ]),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('gtm_datalayer.settings')
      ...
      ->set('single_mode', $values['single_mode'])
